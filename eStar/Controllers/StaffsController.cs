    ...
    public class StaffsController : Controller
    {
        ...
        public async System.Threading.Tasks.Task<ActionResult> Create([Bind(Include = "User_ID,Email,Password,Prefix,First_Name,Surname,User_Type,Job_Role,Weekly_Points,Remaining_Points,Admin")] Staff staff)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                //send email
                var body = "<p>Hi {0}, </p><p>An account has been set up for the email address: {1} with eStar.</p><p>Please go to the eStar site and register a password. </p><p> Account details:<ul><li>Name: {2} {0} {3}</li><li>User: {4}</li></ul></p><p>Thank you.</p><p>eStar</p>";
                string messageBody = string.Format(body, staff.First_Name, staff.Email, staff.Prefix, staff.Surname, staff.User_Type);
        ...
        public async System.Threading.Tasks.Task<ActionResult> Edit([Bind(Include = "User_ID,Email,Password,Prefix,First_Name,Surname,User_Type,Job_Role,Weekly_Points,Remaining_Points")] Staff staff)
        {
            if (ModelState.IsValid)
            {
                ...
                //send email
                var body = "<p>Hi {0}, </p><p>The following changes have been made to the following account: {1} with eStar.</p><p>Account details:<ul><li>Name: {2} {0} {3}</li><li>User: {4}</li></ul></p><p>Thank you.</p><p>eStar</p>";
                string messageBody = string.Format(body, staff.First_Name, staff.Email, staff.Prefix, staff.Surname, staff.User_Type);
                string to = "bethany.fowler14@gmail.com";
                string from = "estar.smtp.fowler@gmail.com";
